		...
		$scope.submitForm = function() {
				if ($scope.registrationForm.$valid) {
						...
						UserAPIService.callAPI(URL + "accounts/register/", $scope.registrationUser).then(function(results) {
								...
								alert("You have successfully registered to Angular To-Do");
								$scope.login();
						}).catch(function(err) {
...
// this is my own code for login controller
...
// now we go back to CI given code which should have no errors
	...
	.controller('EditTodoController', function($scope, $locaiton, $routeParams, TodoAPIService, store) {
